# Super's Minecraft Recommendations
...
* ### TLauncher 
	...
	* Refer to [In Game Purchases]([url](https://github.com/superpowers04/superpowers04/blob/main/Super's%20Fabric%20Mod%20Recommendations.md#in-game-purchases)).
* ### CurseForge/CurseForge Launcher
	...
	* I'd **only** recommend using curseforge if you can't find a mod on Modrinth or MCArchive, for older versions of the game or if you have to.
        * Refer to the suggested mod loaders at the top of this page.
* ### OptiFine
	...
	* Can cause a lot of issues due to how it changes rendering.
 	* [Sodium](https://modrinth.com/mods/sodium)/[Embeddium](https://modrinth.com/mods/Embeddium) provides far better performance and you can find alternatives with more features.
	* \* Note: If you're using any Minecraft version below 1.14, most mods usually expect OptiFine.
* ### Essential 
	* Often force installed by other mods that rely on Essential.
	* Refer to [In Game Purchases]([url](https://github.com/superpowers04/superpowers04/blob/main/Super's%20Fabric%20Mod%20Recommendations.md#in-game-purchases)).
	* \* Refer to Figura below for a *free* cosmetics alternative and refer to E4MC below for a hosting alternative.

# Recommendations
* ### [Modrinth](https://modrinth.com/) 
	* Open sourced, lightweight, ethical owners, and fufills all the tasks that CurseForge does.
* ### [Fabric](https://fabricmc.net/) 
	* Fabric is more lightweight than Forge, and since the loader isn't dependant on Minecraft version, you'll usually get a fabric release within the first few days of a Minecraft update.
* ### [Quilt](https://quiltmc.org/en/) 
	* Quilt is like fabric but adds some extra features. If you use QSL you are able to load Fabric mods alongside Quilt mods.
* ### [NeoForge](https://neoforged.net)
	* NeoForge is a fork of Forge that provides a better developer experience and a more performant experience. With [Sinytra](https://modrinth.com/mod/connector), you can add support for a good portion of Fabric-only mods. Note that doing this is unstable, and may cause issues.
...
* ### [MultiMC](https://multimc.org) 
	* An advanced lightweight Minecraft Launcher that's portable, allows multiple instances of the game without too much hassle, and easy installing of mod loaders like Fabric. Superseded by Prism Launcher, but is still a valid option.
